...
//         header.accountView.layer.sublayers?.last?.shadowColor =
//           darkMode ? UIColor.black.cgColor : accountColor?.cgColor
...
//       var accountAddressWidth =
//         header.accountAddress.frame.size.width + header.accountDropdown.frame.size.width
//         + dropdownMarginLeft + padding * 2
...
//     tableView.register(
//       UINib(nibName: "TransactionListViewCell", bundle: nil),
//       forCellReuseIdentifier: "TransactionListViewCell")
//     tableView.register(
//       UINib(nibName: "TransactionListRequestViewCell", bundle: nil),
//       forCellReuseIdentifier: "TransactionListRequestViewCell")
//     tableView.register(
//       UINib(nibName: "TransactionListLoadingViewCell", bundle: nil),
//       forCellReuseIdentifier: "TransactionListLoadingViewCell")
...
//       header.accountView.addTarget(
//         self, action: #selector(onAvatarPressed(_:)), for: .touchUpInside)
//       header.accountView.addTarget(self, action: #selector(onPressInAvatar(_:)), for: .touchDown)
//       header.accountView.addTarget(
//         self, action: #selector(onPressInAvatar(_:)), for: .touchDragInside)
//       header.accountView.addTarget(
//         self, action: #selector(onPressOutAvatar(_:)), for: .touchUpInside)
//       header.accountView.addTarget(
//         self, action: #selector(onPressOutAvatar(_:)), for: .touchDragOutside)
//       header.accountView.addTarget(self, action: #selector(onPressOutAvatar(_:)), for: .touchCancel)
//       header.accountView.addTarget(
//         self, action: #selector(onPressOutAvatar(_:)), for: .touchUpOutside)
//     } else {
//       header.accountView.isEnabled = false
//     }
//     header.accountButton.addTarget(
//       self, action: #selector(onAccountAddressPressed(_:)), for: .touchUpInside)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressInAccountAddress(_:)), for: .touchDown)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressInAccountAddress(_:)), for: .touchDragInside)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressOutAccountAddress(_:)), for: .touchUpInside)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressOutAccountAddress(_:)), for: .touchDragOutside)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressOutAccountAddress(_:)), for: .touchCancel)
//     header.accountButton.addTarget(
//       self, action: #selector(onPressOutAccountAddress(_:)), for: .touchUpOutside)
//
//     header.copyAddress.addTarget(
//       self, action: #selector(onCopyAddressPressed(_:)), for: .touchUpInside)
//     header.copyAddress.addTarget(self, action: #selector(onPressInCopyAddress(_:)), for: .touchDown)
//     header.copyAddress.addTarget(
//       self, action: #selector(onPressInCopyAddress(_:)), for: .touchDragInside)
//     header.copyAddress.addTarget(
//       self, action: #selector(onPressOutCopyAddress(_:)), for: .touchUpInside)
//     header.copyAddress.addTarget(
//       self, action: #selector(onPressOutCopyAddress(_:)), for: .touchDragOutside)
//     header.copyAddress.addTarget(
//       self, action: #selector(onPressOutCopyAddress(_:)), for: .touchCancel)
//     header.copyAddress.addTarget(
//       self, action: #selector(onPressOutCopyAddress(_:)), for: .touchUpOutside)
//
...
//       arcCenter: header.accountBackground.center, radius: radius, startAngle: 0,
...
//     header.frame = CGRect(
//       x: 0, y: 0, width: tableView.bounds.width, height: addCashAvailable ? 260 : 185)
//     headerSeparator.frame = CGRect(
//       x: 19, y: header.frame.size.height - 2, width: tableView.bounds.width - 19, height: 2)
...
//     let label = UILabel(
//       frame: CGRect(x: 19, y: 19, width: view.frame.width, height: view.frame.height))
//
//     if sections.count == 0 {
//       return nil
//     }
...
//           withIdentifier: "TransactionListLoadingViewCell", for: indexPath)
//         as! TransactionListLoadingViewCell
//       return cell
//
//     }
//     let item = sections[indexPath.section]
...
//     if item.type == .transactions {
//       let cell =
//         tableView.dequeueReusableCell(withIdentifier: "TransactionListViewCell", for: indexPath)
//         as! TransactionListViewCell
//       let transaction = sections[indexPath.section].data[indexPath.row] as! Transaction
//
//       if let onTransactionPress = onTransactionPress {
...
//       let cell =
//         tableView.dequeueReusableCell(
//           withIdentifier: "TransactionListRequestViewCell", for: indexPath)
//         as! TransactionListRequestViewCell
